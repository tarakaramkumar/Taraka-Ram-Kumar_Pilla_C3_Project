...
@BeforeEach
     ...
     LocalTime closingtime = LocalTime.parse("11:45:00");
     restaurant = new Restaurant("Ameli's cafe", "Chennai",openingtime,closingtime);
     restaurant.addToMenu("Sweet corn soup",119);
     restaurant.addToMenu("Vegetable Lasange",269);
    //>>>>>>>>>>>>>>>>>>>>>>>>>OPEN/CLOSED<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
